...
contains
  ...
  subroutine usage()
     write(*,*) '--------------------------------------------------------------'
     write(*,*) 'Usage:' 
     write(*,*) ' ./extract_boundaries <field.fld> <mesh file> <boundary_id>'
     write(*,*) ' ./extract_boundaries <field.fld> <case file> <boundary_id>'
     write(*,*) ''
     write(*,*) 'Examples:'
     write(*,*) ' ./extract_boundaries stats0.fld mymesh.nmsh 1'
     write(*,*) ' ./extract_boundaries stats0.fld mycase.case 1'
     write(*,*) ''
