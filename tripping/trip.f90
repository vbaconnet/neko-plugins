...
!! @param[in]    iel             local element number
  subroutine trip_forcing_device( this, fx_d,fy_d,fz_d)
    class(trip_t) :: this
!!!!    class(trip_t), intent(inout) :: this
!!!!  subroutine trip_forcing_device( fx_d,fy_d,fz_d)
