...
module FST
  ...
  type, public :: FST_t
   ...
   contains
     ...
     procedure, pass(this) :: init_from_files => FST_init_from_files
...
contains
  ...
  subroutine FST_init_from_files(this, Uinf)
    ...
    if (pe_rank .eq. 0) then
       ...
       ! 1. Read sphere.dat to get number of spheres
  ...
  subroutine FST_print_params(this)
    ...
    write(*, *) "xstart", this%xstart
    write(*, *) "xend", this%xend
    write(*, *) "ystart", this%ystart
    write(*, *) "yend", this%yend
    write(*, *) "fringe_max", this%fringe_max
    write(*, *) "x_delta_rise", this%x_delta_rise
    write(*, *) "x_delta_fall", this%x_delta_fall
    write(*, *) "y_delta_rise", this%y_delta_rise
    write(*, *) "y_delta_fall", this%y_delta_fall
    write(*, *) "t_start", this%t_start
    write(*, *) "t_end", this%t_end
  ...
  subroutine FST_generate_bc(this, coef, bc_mask, n, u, v, w, regen)
    class(FST_t), intent(inout) :: this
    type(coef_t), intent(in) :: coef
